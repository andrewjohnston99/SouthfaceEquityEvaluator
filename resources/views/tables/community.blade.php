    ...
    <table id="commTable" class="table table-bordered">
        <thead>
            <tr class="text-center">
                <th class="text-center align-middle font-weight-bold title" colspan="2">BALANCED COMMUNITY</th>
        ...
        <tbody>
            ...
            <tr class="text-center">
                <th scope="row" class="align-middle">BC 0.1</th>
            ...
            <tr class="text-center">
                <th scope="row" rowspan="5" style="padding-top: 30px;">BC 1.0</th>
            ...
            <tr class="text-center">
                <th scope="row" class="align-middle">BC 1.3</th>
                <td class="text-left align-middle">LEFT INTENTIONALLY BLANK</td>
                <td class="align-middle" colspan="1">TBD</td>
                <td class="align-middle"></td>
                <td class="align-middle">
